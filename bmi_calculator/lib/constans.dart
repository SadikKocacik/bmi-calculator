...
const kWeightTextStyle = TextStyle(fontSize: 50, fontWeight: FontWeight.w900);
...
const kResult2TextStyle = TextStyle(
    fontSize: 22,
    fontWeight: FontWeight.bold,
    color: Color.fromARGB(255, 213, 204, 23));

const kResult3TextStyle = TextStyle(
    fontSize: 22,
    fontWeight: FontWeight.bold,
